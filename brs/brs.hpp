...
struct BRSHeader1 {
	...
	std::optional<uint64_t> saveTime; // TODO: use time
	int32_t brickCount;
};
...
class BRSReader
{
	...
	std::optional<BRSHeader1> header1;
	std::optional<BRSHeader2> header2;
	std::optional<BRSBricks> bricks;
public:

	BRSReader(std::string filepath);
	...
	BRSHeader1 getHeader1();
	BRSHeader2 getHeader2();
	BRSBricks getBricks();
...
BRSReader::BRSReader(std::string filepath): reader_(std::ifstream(filepath, std::ios::in | std::ios::binary))
{
...
inline int64_t BRSReader::read_int64()
{
	int64_t a;
	reader_.read(reinterpret_cast<char*>(&a), sizeof(a));
	return a;
...
inline uint8_t BRSReader::read_uint8()
{
	uint8_t a;
	reader_.read(reinterpret_cast<char*>(&a), sizeof(a));
	return a;
...
uint16_t BRSReader::read_uint16()
{
	uint16_t a;
	reader_.read(reinterpret_cast<char*>(&a), sizeof(a));
	return a;
...
inline uint32_t BRSReader::read_uint32()
{
	uint32_t a;
	reader_.read(reinterpret_cast<char*>(&a), sizeof(a));
	return a;
...
inline uint64_t BRSReader::read_uint64()
{
	uint64_t a;
	reader_.read(reinterpret_cast<char*>(&a), sizeof(a));
	return a;
...
inline std::u16string BRSReader::read_string()
{
...
inline bool BRSReader::loadedHeader1()
{
	return header1.has_value();
}

inline bool BRSReader::loadedHeader2()
{
	return header2.has_value();
}

inline bool BRSReader::loadedBricks()
{
	return bricks.has_value();
}

inline BRSHeader1 BRSReader::getHeader1()
{
...
inline BRSHeader2 BRSReader::getHeader2()
{
...
inline BRSBricks BRSReader::getBricks()
{
	if (bricks.has_value()) {
		return bricks.value();
	}
...
inline void BRSReader::readHeader1()
{
	...
	header1 = std::optional<BRSHeader1>{result};
}

inline void BRSReader::readHeader2()
{
}

inline void BRSReader::readBricks()
{
